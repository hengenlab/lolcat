...
class Dataset:
    ...
    def load_train_val_test_split(self,split_filename):
        ...
        unit_id_splitset_dict = dict(zip(split_df.unit_id,split_df.set))
        cell_ids_sets = np.vectorize(unit_id_splitset_dict.get)(self.cell_ids)
        train_mask = cell_ids_sets == 'train'
        test_mask = cell_ids_sets == 'test'
        val_mask = cell_ids_sets == 'test'
